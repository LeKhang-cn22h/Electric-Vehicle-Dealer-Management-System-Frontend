        ...
        <div class="max-w-4xl mx-auto">
            ...
            <header class="mb-8">
                <div class="flex justify-between items-center">
                    ...
                    <button @click="goBack" class="text-gray-600 hover:text-gray-900 flex items-center gap-2">← Quay lại</button>
                </div>
            </header>
            ...
            <div v-else-if="quotation" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-8">
                ...
                <div class="border border-gray-200 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <!-- Số tiền thanh toán -->
                        <div>
                            <label class="block text-sm text-gray-600 mb-1">Số tiền thanh toán</label>
                            <input
                                type="number"
                                min="0"
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div v-if="quotation.discountAmount > 0" class="flex justify-between">
                            <span class="text-gray-600">Giảm giá:</span>
                            <span class="text-green-600 font-medium">-{{ formatCurrency(quotation.discountAmount) }}</span>
                        </div>
                        <div class="flex justify-between">
                        ...
                        <div class="flex justify-between text-lg font-bold border-t pt-3">
                            ...
                            <span class="text-blue-600">{{ formatCurrency(quotation.totalAmount) }}</span>
                        </div>

                        <div v-if="payment.paymentMethod === 'bank_transfer'" class="text-sm text-gray-600">
...
const itemsTotal = computed(() => {
    return quotation.value?.items.reduce((sum, item) => sum + (item.quantity ? item.quantity : 0) * item.unit_price, 0);
});
