        ...
        <div class="bg-white rounded-lg shadow-xl max-w-6xl w-full max-h-[90vh] flex flex-col">
            ...
            <div class="flex-1 overflow-y-auto p-6">
                ...
                <div v-else-if="error" class="text-center py-12">
                    ...
                    <button @click="loadProducts" class="text-blue-600 hover:underline text-sm">Thử lại</button>
                </div>
                ...
                <div v-else-if="filteredProducts.length === 0" class="text-center py-12 text-gray-500">
                    ...
                    <button v-if="hasFilters" @click="clearFilters" class="mt-3 text-blue-600 hover:underline text-sm">
                        Xóa bộ lọc
                    </button>
                </div>
                ...
                <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    >
                        ...
                        <div class="aspect-video bg-gray-100 rounded-lg mb-3 overflow-hidden relative">
                            ...
                            <div
                                v-if="!getImageUrl(product)"
                                class="absolute bottom-2 left-2 right-2 bg-red-500 text-white text-xs p-1 rounded"
                            >
                                No image_url field
                            </div>
                        </div>
...
// ====================== API ======================
const { fetchAll, fetchModels, getListVehiclePrice, models, loading, error } = useVehicle();
...
const hasFilters = computed(() => filters.search || filters.model || filters.status || filters.priceRange);
...
const getImageUrl = (product: any): string => {
    ...
    const possibleFields = ["image_url", "imageUrl", "image", "thumbnail", "photo_url", "avatar_url", "images", "picture"];
...
const getPrice = (product: any): number => {
    ...
    return product.price || product.selling_price || product.sellingPrice || product.sale_price || product.salePrice || 0;
};
