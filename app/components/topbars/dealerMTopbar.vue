        ...
        <div class="topbar-content">
            ...
            <div class="nav-section">
                ...
                <template v-if="isDealerStaff">
                    <NuxtLink to="/user/quotations" class="nav-item"> Báo giá của tôi </NuxtLink>

                    <NuxtLink to="/user/orders" class="nav-item"> Đơn hàng của tôi </NuxtLink>

                    <NuxtLink to="/dealer_staff/payments/vnpay-demo" class="nav-item"> Thanh toán VNPay </NuxtLink>
                ...
                <template v-if="isDealerManager">
                    <NuxtLink to="/dealer_manager/discounts" class="nav-item"> Quản lý chiết khấu </NuxtLink>
