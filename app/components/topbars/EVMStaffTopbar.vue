    ...
    <nav class="evm-staff-topbar">
        <div class="topbar-content">
            ...
            <div class="nav-section">
                ...
                <router-link to="/vehicle_unit" class="nav-item">Điều phối</router-link>
...
const userName = computed(() => {
    ...
    return user.user_metadata?.full_name || user.full_name || user.fullName || user.email?.split("@")[0] || "User";
});
</script>
