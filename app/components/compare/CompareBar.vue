<template>
    <div
        ...
        class="fixed bottom-4  -translate-x-1/2 bg-white shadow-xl rounded-2xl p-4 flex items-center gap-4 max-w-4xl w-[90%] border border-gray-200 z-50 animate-fade-in"
    >
